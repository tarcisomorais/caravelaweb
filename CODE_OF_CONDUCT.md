...
reported privately to the project maintainer. Use the repository's private
reporting channel when available. If no private channel is available, open an
issue containing no sensitive details and request private contact.
