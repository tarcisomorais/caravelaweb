...
not the CaravelaWeb contract and holds no runtime code.

The canonical contract is `SKILL.md` at the repository root: `../../..` from
the directory holding this adapter. Derive that root from this file's location,
